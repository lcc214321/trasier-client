...
@Configuration
@ComponentScan(basePackageClasses = {TrasierSpringNoopConfiguration.class, TrasierSpringClient.class, TrasierSpringAccessor.class, TrasierSampleByOperationInterceptor.class})
