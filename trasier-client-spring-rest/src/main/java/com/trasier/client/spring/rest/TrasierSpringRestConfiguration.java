...
@Configuration
@ComponentScan(basePackageClasses = {TrasierSpringRestConfiguration.class, TrasierSpringClient.class, TrasierSpringAccessor.class, TrasierSampleByOperationInterceptor.class})
